module ApplicationHelper
  ...
  def sidebar_menu_items
    ...
    if master_admin?
      ...
      links << { path: app_versions_path(app_name: AppVersion.app_names['bristol_cable']), id: 'app-versions-link', header: 'App versions', icon: 'sliders.svg', text: 'App versions', active_if: 'app_versions' }
